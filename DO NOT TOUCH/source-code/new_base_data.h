                       ...
                       if(data->priority==1 && HIGHEST_PRIORITY_FLAG==NO)//first highest priority route, 
                        ...
                        else
                        {
                           ...
                           if(best_cat=='s'&& grey->grey_char=='s')
                           {
                               ...
                               {
                                    selected_index=Select_if_same_index(best_index,base->base_index,candidate->ap_index,candidate->takeoff_time,candidate->ac_type);//desti1,desti2,source NEU_MAC (+actype)
